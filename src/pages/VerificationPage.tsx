              ...
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl flex gap-3 items-start">
                ...
                <div>
                  <h4 className="text-xs font-bold text-amber-500 mb-1">
                    {lang === 'ko' ? '만남의 신뢰도를 높여주는 eKYC 본인인증' : '出会いの信頼度を高めるeKYC本人確認'}
                  </h4>
                  <p className="text-[11px] text-amber-400/70 leading-relaxed">
                    {lang === 'ko'
                      ? '본인 신분증 서류(여권, 신분증 등)를 한 장 제출해주세요. 업로드 즉시 AI가 얼굴과 성명을 안전하게 대조 판독하여 [신원 인증 배지]를 실시간 부여합니다.'
                      : '身分証明書（パスポート、マイナンバーカード等）をご提出ください。アップロード後、AIが顔と氏名を即時照合し、「本人確認済みバッジ」を自動付与します。'}
                  </p>
                </div>
              </div>
